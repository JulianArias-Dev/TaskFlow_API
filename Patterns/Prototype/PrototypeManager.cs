...
/// <summary>
/// Implementaci�n avanzada del patr�n Prototype para Task
/// Proporciona clonado profundo (Deep Copy) simulando RF-02.5
/// </summary>
public class TaskPrototype : TaskEntity, IPrototype
{
    /// <summary>
    /// Realiza un clonado profundo mediante serializaci�n JSON
    ...
    public new object Clone()
    {
        ...
        catch
        {
            ...
            return new TaskPrototype
            {
				...
				{
					UserId = a.UserId,
					TaskId = Guid.Empty, // Se asignar� al guardar la nueva tarea
...
/// <summary>
/// Implementaci�n avanzada del patr�n Prototype para Project
