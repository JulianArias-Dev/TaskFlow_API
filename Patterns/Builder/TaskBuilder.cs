...
/// <summary>
/// Patr�n Builder: Permite la construcci�n paso a paso de una tarea
/// con configuraci�n detallada y flexible
/// </summary>
...
public class ProjectBuilder
{
    ...
    /// <summary>
    /// Asigna el estado por id del catálogo (1=Active, 2=Completed, ...).
