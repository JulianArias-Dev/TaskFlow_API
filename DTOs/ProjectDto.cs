...
public class CreateProjectDto
{
	...
	[Range(1, int.MaxValue, ErrorMessage = "Debe proporcionar un ID de estado válido")]
	public int StatusId { get; set; } = 1; // Por defecto: 1 (Active)
}
...
public class UpdateProjectDto
{
	...
	[Range(1, int.MaxValue, ErrorMessage = "El ID de estado proporcionado no es válido")]
